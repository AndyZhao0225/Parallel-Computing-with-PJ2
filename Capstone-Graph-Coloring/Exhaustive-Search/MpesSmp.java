...
/**
 * Class MpesSmp provides a color assignment solution to a given graph
 * with the minimum number of colors, using exhaustive search algorithm.
 *
 * @author  Junan Zhao
 * @version 21-Apr-2019
 */
public class MpesSmp extends Task
{
   ...
   public void printSolution()
   {
      System.out.println("\n\nSolution\n");
      for( int i=0; i<=this.graph.V()-1; i++)
          System.out.println("Vertex " + i + " = Color " + globalColorAssigned[i]);
      System.out.println("\nMin num of colors = " + c + "\n");
   }
   ...
   {
      System.err.println ("Usage: java pj2 MpesSmp <ctor>");
