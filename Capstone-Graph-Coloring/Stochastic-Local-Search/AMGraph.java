...
// Hidden data members.  
   ...
   private BitSet[] adjacent;  // The graph's adjacency matrix. adjacent[i] is 
                               //the set of vertices adjacent to vertex i.
...
// Exported constructors.
   ...
   public AMGraph()
   {
     ...
     */
    public AMGraph( GraphSpec gspec)
    {
       set(gspec);
    }
...
// Exported operations.
    ...
    /**
      * Get the adjacent vertices of the i-th vertex 
      *
    ...
    /**
      ...
      * @param  gspec  Graph specification.
      */
    public void set( GraphSpec gspec)
    {
       V = gspec.V();
       if(V<0) 
          throw new IllegalArgumentException(String.format("AMGraph.set(): V = %d illegal",V));
    ...
    */
   public boolean isVertexCover(BitSet vset)
   {
      boolean covered = true;
      for( int i=0; covered && i < V; ++i)
	  if(!vset.contains(i))  covered = adjacent[i].isSubsetOf (vset);
      return covered;
   }
